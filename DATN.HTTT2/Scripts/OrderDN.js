$(function () {
    ...
    $("#submit").click(function () {
        ...
        if (itemsList.length == 0) {
            $('#orderMessage').text('Thêm chi tiết đơn hàng!');
            isValid = false;
        }
        if (document.getElementById("daily").value == '' || document.getElementById("diachi").value == '') {
            $('#orderMessage').text('Kiểm tra thông tin khách hàng');
            isValid = false;
        }
        ...
        if (isValid) {
            ...
            $("#submit").html('Đang lưu đơn đặt hàng ...');
